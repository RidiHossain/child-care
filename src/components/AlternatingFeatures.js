...
const blocks = [
  {
    ...
    headline: 'Creating a secure environment where children thrive',
    text: 'At Bright Child Care, we prioritize your child\'s safety and emotional well-being. Our caregivers create a warm, nurturing atmosphere where children feel secure and loved. We maintain small group sizes and low child-to-caregiver ratios to ensure individual attention and care.',
    image: { src: blockImage1, alt: 'Child covered in paint' },
  },
  {
    tagline: 'Individual Attention',
    headline: 'Every child receives personalized care and support',
    text: 'We understand that each child is unique and develops at their own pace. Our experienced caregivers observe and support each child\'s individual needs, interests, and developmental milestones. We provide age-appropriate activities that challenge and engage every child.',
    image: { src: blockImage2, alt: 'Child painting' },
  },
  {
    tagline: 'Learning Through Play',
    headline: 'Developmentally appropriate activities that make learning fun',
    text: 'Our child care programs focus on learning through play and hands-on experiences. Children develop essential skills through creative activities, outdoor play, music, art, and social interactions. We create an environment where learning is natural, enjoyable, and meaningful.',
