        ...
        <div className="md:grid md:grid-cols-2 md:gap-12 lg:gap-16">
          <div>
            <h2 className="h2 max-w-4xl text-purple-900">
              Quality child care programs for every age
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-xl leading-relaxed text-purple-800 sm:mt-5 lg:text-left">
              From infants to preschoolers, we provide nurturing, age-appropriate care that supports your child's development and growth at every stage.
            </p>
          </div>
        </div>
        {/* School programs */}
