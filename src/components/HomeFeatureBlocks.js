...
const blocks = [
  {
    tagline: 'Nurturing development',
    headline: "Supporting your child's growth and learning",
    text: 'Our child care programs are designed to support each child\'s natural development. From infants to preschoolers, we provide age-appropriate activities that encourage learning through play, social interaction, and exploration.',
    action: { label: 'View Programs', href: '/programs', icon: true },
    portraitImage: { src: portraitImage1, alt: 'Children learning and playing' },
    squareImage: { src: squareImage1, alt: 'Caregiver with children' },
  },
  {
      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="relative">
          ...
          <h2 className="h2 mx-auto max-w-4xl text-center text-purple-900">
            Quality child care for every age and stage
          </h2>
          <p className="mx-auto mt-4 max-w-3xl text-center text-xl leading-relaxed text-purple-800">
            We provide age-appropriate care and learning experiences for children from 
            infants to preschoolers. Our experienced caregivers create a nurturing 
            environment where each child can thrive and develop at their own pace.
          </p>
          {/* Feature list */}
